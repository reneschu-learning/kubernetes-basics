...
This demo is designed to be run on a Kubernetes cluster created through Docker Desktop using Kind. If you are running on a different cluster, the commands may vary slightly.
