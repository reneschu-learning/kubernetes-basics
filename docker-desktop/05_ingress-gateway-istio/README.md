...
Before we start, let's make sure that the NGINX Ingress controller is installed in our cluster. If you haven't installed it yet, you can do so by following the instructions in the [NGINX Ingress Controller documentation](https://kubernetes.github.io/ingress-nginx/deploy/). The simplest way to install it is by running the following command:
...
Open your browser and navigate to `http://gallery.local/v4` to see the first version of the application, and `http://gallery.local/v5` to see the second version. You should see different versions of the application being served through the same public IP address, with different paths for each version.
...
Before we start, let's make sure that Istio is installed in our cluster. If you haven't installed it yet, run the [install-istio.sh](install-istio.sh) file or follow the instructions in the [Istio documentation](https://istio.io/latest/docs/setup/getting-started/). At the end of the installation, you should see a message similar to this:

```
NAME            NAMESPACE       REVISION        UPDATED                                         STATUS          CHART           APP VERSION
istio-base      istio-system    1               2026-07-20 17:09:07.59354576 +0200 CEST         deployed        base-1.30.2     1.30.2     
istio-cni       istio-system    1               2026-07-20 17:09:15.949103011 +0200 CEST        deployed        cni-1.30.2      1.30.2     
istiod          istio-system    1               2026-07-20 17:09:09.703612101 +0200 CEST        deployed        istiod-1.30.2   1.30.2     
ztunnel         istio-system    1               2026-07-20 17:09:30.45542337 +0200 CEST         deployed        ztunnel-1.30.2  1.30.2
```
...
If you want, you can also uninstall Istio by running the [uninstall-istio.sh](uninstall-istio.sh) file or following the instructions in the [Istio documentation](https://istio.io/latest/docs/setup/getting-started/). In case you want to learn more about Istio, check out the [Istio documentation](https://istio.io/latest/docs/). It provides a lot of information about the features and capabilities of Istio, including traffic management, security, observability, and more.